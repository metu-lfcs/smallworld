...
"This section works on the outputs of the lalr-parser, turning them into lexical categories and writing them to the debug lexicon file. That file will be readed by uni-cg module to construct the online lexicon for parsing linguistic input."
...
(defun run (project-path)
  ...
  (format t "~%Reading the theory found at ~a . . .~%"
		  (pathname-name (setf *theory-file-path* (make-pathname :name (concatenate 'string project-path "/theory.lisp")))))
  ...
  (format t "~%Parsing the lexicon found at ~a . . .~%"
		  (pathname-name (setf *lexicon-file-path* (make-pathname :name (concatenate 'string project-path "/lexicon.lisp")))))
  ...
  (setf *debug-lexicon-path* (make-pathname :name (concatenate 'string project-path "/_lexicon.lisp")))
